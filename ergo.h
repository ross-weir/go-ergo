...
typedef const struct Tokens *ConstTokensPtr;

typedef struct Tokens *TokensPtr;
 ...
 * Get tokens for box
 */
void ergo_lib_ergo_box_tokens(ConstErgoBoxPtr ergo_box_ptr, TokensPtr *tokens_out);
...
ErrorPtr ergo_lib_simple_box_selector_select(ConstSimpleBoxSelectorPtr simple_box_selector_ptr,
                                             ...
                                             ConstTokensPtr target_tokens_ptr,
                                             BoxSelectionPtr *box_selection_out);
 ...
 */
ErrorPtr ergo_lib_tokens_add(ConstTokenPtr token_ptr, TokensPtr tokens_ptr);

/**
 * Drop `Tokens`
 */
void ergo_lib_tokens_delete(TokensPtr ptr);

/**
 * If token at given index exists, allocate a copy and store in `token_out`.
 */
struct ReturnOption ergo_lib_tokens_get(ConstTokensPtr tokens_ptr,
                                        uintptr_t index,
                                        TokenPtr *token_out);
 ...
 */
uintptr_t ergo_lib_tokens_len(ConstTokensPtr tokens_ptr);

/**
 * Create an empty collection
 */
void ergo_lib_tokens_new(TokensPtr *tokens_out);
 ...
 */
void ergo_lib_tx_builder_min_change_value(ConstTxBuilderPtr tx_builder_ptr,
                                          BoxValuePtr *min_change_value_out);
...
void ergo_lib_tx_builder_new(ConstBoxSelectionPtr box_selection_ptr,
                             ...
                             ConstBoxValuePtr min_change_value_ptr,
